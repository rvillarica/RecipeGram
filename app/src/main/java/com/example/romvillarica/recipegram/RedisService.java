...
public class RedisService {
    ...
    interface Service {
        ...
        @PUT("SET/{key}")
        Call<SetResponse> makePost(@Path("key") String key, @Body UserPost body);
    ...
    class GetResponse {
        @SerializedName("GET")
        UserPost userPost; // ListItem is a Java class that holds data in your RecyclerView
    }
    ...
    static Service getService() {
        if (service == null) {
            ...
            Retrofit retrofit = new Retrofit.Builder()
                    .baseUrl("http://ec2-54-210-25-34.compute-1.amazonaws.com/879a6589b75ce798f587e68ab76c8237a9/")
